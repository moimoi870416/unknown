...
public class MapLoader {
    ...
    public ArrayList<GameObject> createObjectArray(final String gameObject, final int mapObjectSize, final ArrayList<MapInfo> mapInfo, final CompareClass compare) {
