...
//                    gameActorArr.get(i).tradeGun(new Gun(Gun.GunType.valueOf(strs.get(5)),Integer.valueOf(strs.get(6)),Integer.valueOf(strs.get(7))));
//                }
...
//                mouseY = Integer.valueOf(strs.get(9));
    ...
    private void gunReceive(GameActor gameActor,ArrayList<String> strs){
        ...
        gameActor.getRotation().angleBetweenTwoPointWithFixedPoint(Integer.valueOf(strs.get(8)),Integer.valueOf(strs.get(9)));
